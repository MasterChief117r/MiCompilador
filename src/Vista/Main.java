...
import Codigo.Error;
import Codigo.Pila;
import Codigo.RenderizadordeCeldasdeTabla;
...
public class Main extends javax.swing.JFrame {
    ...
    private ArrayList<Analizar> listAnalyse;
    ArrayList<Codigo> codeList;
    File file;
    Acerdade about;
    /**
    ...
    private void initComponents() {
        ...
        menuItemClose.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        menuItemLexic.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        menuItemSintatic.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_T, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        menuItemSemantic.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        menuItemIntermediateCode.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_G, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        menuItemExecute.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_X, java.awt.event.InputEvent.CTRL_DOWN_MASK));
    ...
    private void menuItemOpenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemOpenActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Orden de apertura cancelada por el usuario.");
        }
    ...
    private void menuItemLexicActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemLexicActionPerformed
        ...
        if ( textPaneAreaEdit.getText() != "" )
            ...
            JOptionPane.showMessageDialog(null, "Error ! Sin texto ! necesita llenar el textArea !");
        
        // Popula Table
        populateLexicalTable(listAnalyse);
        
        if ( listAnalyse.get( listAnalyse.size() - 1).getLexema().equals("Error") )
            JOptionPane.showMessageDialog(null, "Error ! Te faltó cerrar el comentario !");
        else
            JOptionPane.showMessageDialog(null, "Análisis léxico finalizado con éxito !");
        
        tabbedPaneLexical.setSelectedIndex(0);
    }//GEN-LAST:event_menuItemLexicActionPerformed

    private void menuItemCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemCloseActionPerformed
        int input = JOptionPane.showConfirmDialog(this, "De verdad quieres cerrar la aplicación ?");
    ...
    private void menuItemSintaticActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemSintaticActionPerformed
        ...
        if ( textPaneAreaEdit.getText() != "" ) {
            if ( (list = control.analyseSintatic(textPaneAreaEdit.getText())).size() == 1 && list.get(0).getLinea().equals("-1") ) {
                textAreaResult.setText("El análisis sintáctico fue un éxito !!\n Sin errores !!\n");
                JOptionPane.showMessageDialog(null, "Análisis sintáctico finalizado con éxito ! Sin errores !");
            } else {
                for (Error s: list ) {
                    temp += s.getError() + "  /  Linea = " + s.getLinea() + "\n";
                ...
                JOptionPane.showMessageDialog(null, "Análisis sintáctico ! Errores obtenido !");
            }    
        }
        else 
            JOptionPane.showMessageDialog(null, "Error ! Sin texto ! necesita llenar el textArea !");
    ...
    private void menuItemSemanticActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemSemanticActionPerformed
        ...
        if ( !textPaneAreaEdit.getText().equals("") ) {
            ...
            if ( list.size() == 1 && list.get(0).getLinea().equals("-1") ) {
                textAreaResultSemantic.setText("El análisis semántico se ha realizado crrectamente !!\n Sin errores !!\n");
                JOptionPane.showMessageDialog(null, "Análise Semantica realizada com sucesso ! Sem erros !");
            } 
            
            else {
                if ( list.get(list.size() - 1).getLinea().equals("999") ) {
                ...
                if ( errorSintatic )
                    JOptionPane.showMessageDialog(null, "Análisis sintáctico con errores ! No se ha realizado ningún análisis semántico ! Errores sintácticos !");
                else
                    JOptionPane.showMessageDialog(null, "Análisis Semantica ! Errores obtenidos !");
            }
            ...
            JOptionPane.showMessageDialog(null, "Error ! Sin texto ! necesitas llenar el textArea !");
    ...
    private void menuItemExecuteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemExecuteActionPerformed
        ...
        if ( !codeList.isEmpty() ) {
            for ( Codigo c: codeList) {
                if ( c.getCodigo().equals("AMEM 1") ) {
                    String valor = JOptionPane.showInputDialog("Introduzca un número entero: ");
                    result += "Introduzca un número entero: \n";
                ...
                } else if ( c.getCodigo().equals("ARMZ 0") ) {
                    stack.push(x);
                } else if ( c.getCodigo().equals("ARMZ 1") ) {
                    stack.push(y);
                } else if ( c.getCodigo().equals("CMMA") ) {
                    if ( x > y ) {
                        maior = x;
                    }
                ...
                } else if ( c.getCodigo().equals("CMME") ) {
                ...
                else if ( c.getCodigo().equals("PARA") ) {
                    break;
                }
            }
        }
    ...
    public void populateLexicalTable(ArrayList<Analizar> list)
    {
        ...
        {   
            ...
            rowData[2] = list.get(i).getLinea();
            rowData[3] = list.get(i).getColIni();
            rowData[4] = list.get(i).getColFinal();
            rowData[5] = list.get(i).getError();
            
            model.addRow(rowData);
        }
        
        tableLexical.setDefaultRenderer(Object.class, new RenderizadordeCeldasdeTabla(wrong));
